...
type Store struct {
	...
	// snapshotMu serializes snapshot writes: the refresh loop fans out all
	// four caches in parallel, and each finishing refresh calls
	// persistSnapshot — they must not share one temp file.
