...
// about: vixsrc, all nine vidking source servers and vidsrcme. Unlike
// production Resolve() — which stops at the first
...
//	BW_PROVIDERS=vixsrc,vidking,vidsrcme   (comma-separated subset)
